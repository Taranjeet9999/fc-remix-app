          ...
          <div className="add-payment-methods">
            ...
            <div className="submit">
              <button
                ...
                onClick={() => {
                  window.open(
                    `${localStorage.getItem("isProduction").includes("1")?  "https://portal.fastcourier.com.au"  :"https://portal.fastcourier.com.au"}/quick-login?access_token=${localStorage.getItem(
                      "accessToken"
