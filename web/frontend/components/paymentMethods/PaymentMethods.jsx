          ...
          <div className="add-payment-methods">
            ...
            <div className="submit">
              <button
                ...
                onClick={() => {
                  window.open(
                    `${localStorage.getItem("isProduction").includes("1")?  "https://portal-staging.fastcourier.com.au"  :"https://portal-staging.fastcourier.com.au"}/quick-login?access_token=${localStorage.getItem(
                      "accessToken"
